...
const VERSION = 'version_35'; // Version of the offline cache, itterate this number if changes are made and old caches should be cleared
...
const URLS = [
    ...
    '/OtherPages/Enemies.gen.html',
    '/OtherPages/FAQ.html',
    '/OtherPages/GettingStarted.html',
    '/OtherPages/index.html',
    '/OtherPages/Items.gen.html',
    '/OtherPages/Locations.gen.html',
    '/OtherPages/NewMechanics.html',
    '/OtherPages/NPCs.gen.html',
    '/OtherPages/Spellcasting.html',
    '/OtherPages/StatsPage.gen.html',
    '/Assets/jsMin/bundle.js',
    '/Assets/DtgA-logo_Final-GaplessBW.webp',
    '/Assets/DtgA-logo_Final-GaplessBW-lowres.webp',
